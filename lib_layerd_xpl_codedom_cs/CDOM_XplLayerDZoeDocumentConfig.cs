...
[Serializable]
public class XplLayerDZoeDocumentConfig:  XplNode{
...
/*	public ~XplLayerDZoeDocumentConfig(){
	...
	public override CodeDOMTypes get_TypeName(){return CodeDOMTypes.XplLayerDZoeDocumentConfig;}
...
public static XplLayerDZoeDocumentConfig operator +(XplLayerDZoeDocumentConfig arg1, XplNode arg2)
{
...
/// <returns>arg1 node or CodeDOM_Exception if arg1 doesn't has children.</returns>
public static XplLayerDZoeDocumentConfig operator +(XplLayerDZoeDocumentConfig arg1, XplNodeList arg2)
{
    if (arg1.Children() != null)
        arg1.Children().InsertAtEnd(arg2);
    else

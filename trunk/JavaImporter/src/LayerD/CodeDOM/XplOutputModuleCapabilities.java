...
public class XplOutputModuleCapabilities extends  XplNode implements XplNodeListCallbacks {
	...
	public int get_TypeName(){return CodeDOMTypes.XplOutputModuleCapabilities;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_IsCaseSensitive != true)
			writer.WriteAttributeString( "IsCaseSensitive" ,CodeDOM_Utils.Att_ToString(p_IsCaseSensitive) );
		if(p_AllowDefaultSafeArrays != false)
			writer.WriteAttributeString( "AllowDefaultSafeArrays" ,CodeDOM_Utils.Att_ToString(p_AllowDefaultSafeArrays) );
		if(p_AllowDisableArrayLimitsChecks != false)
			writer.WriteAttributeString( "AllowDisableArrayLimitsChecks" ,CodeDOM_Utils.Att_ToString(p_AllowDisableArrayLimitsChecks) );
		if(p_AllowUseSinglePointAsNamespaceSeparator != false)
			writer.WriteAttributeString( "AllowUseSinglePointAsNamespaceSeparator" ,CodeDOM_Utils.Att_ToString(p_AllowUseSinglePointAsNamespaceSeparator) );
		if(p_AllowUseSimpleMemberAccessAsNamespaceSeparator != false)
			writer.WriteAttributeString( "AllowUseSimpleMemberAccessAsNamespaceSeparator" ,CodeDOM_Utils.Att_ToString(p_AllowUseSimpleMemberAccessAsNamespaceSeparator) );
		if(p_AllowMultipleInheritance != false)
			writer.WriteAttributeString( "AllowMultipleInheritance" ,CodeDOM_Utils.Att_ToString(p_AllowMultipleInheritance) );
		...
		if(p_AllowSetUniversalObjectBase != false)
			writer.WriteAttributeString( "AllowSetUniversalObjectBase" ,CodeDOM_Utils.Att_ToString(p_AllowSetUniversalObjectBase) );
		if(p_AllowDisableUnifiedTypeSystem != false)
			writer.WriteAttributeString( "AllowDisableUnifiedTypeSystem" ,CodeDOM_Utils.Att_ToString(p_AllowDisableUnifiedTypeSystem) );
		if(p_AllowEnableIntegerOverflowExceptions != false)
			writer.WriteAttributeString( "AllowEnableIntegerOverflowExceptions" ,CodeDOM_Utils.Att_ToString(p_AllowEnableIntegerOverflowExceptions) );
		if(p_AllowEnableFloatOperationsExceptions != false)
			writer.WriteAttributeString( "AllowEnableFloatOperationsExceptions" ,CodeDOM_Utils.Att_ToString(p_AllowEnableFloatOperationsExceptions) );
		if(p_RequireIntegerOverflowExceptions != false)
			writer.WriteAttributeString( "RequireIntegerOverflowExceptions" ,CodeDOM_Utils.Att_ToString(p_RequireIntegerOverflowExceptions) );
		if(p_RequireFloatOperationsExceptions != false)
			writer.WriteAttributeString( "RequireFloatOperationsExceptions" ,CodeDOM_Utils.Att_ToString(p_RequireFloatOperationsExceptions) );
		if(p_FullDecimalImplementation != true)
			writer.WriteAttributeString( "FullDecimalImplementation" ,CodeDOM_Utils.Att_ToString(p_FullDecimalImplementation) );
		if(p_SupportASCIIChar != false)
			writer.WriteAttributeString( "SupportASCIIChar" ,CodeDOM_Utils.Att_ToString(p_SupportASCIIChar) );
		if(p_SupportASCIIString != false)
			writer.WriteAttributeString( "SupportASCIIString" ,CodeDOM_Utils.Att_ToString(p_SupportASCIIString) );
		if(p_SupportUnsignedIntegers != true)
			writer.WriteAttributeString( "SupportUnsignedIntegers" ,CodeDOM_Utils.Att_ToString(p_SupportUnsignedIntegers) );
		if(p_SupportExtendedValueTypes != true)
			writer.WriteAttributeString( "SupportExtendedValueTypes" ,CodeDOM_Utils.Att_ToString(p_SupportExtendedValueTypes) );
		if(p_SupportExtendedReferenceTypes != true)
			writer.WriteAttributeString( "SupportExtendedReferenceTypes" ,CodeDOM_Utils.Att_ToString(p_SupportExtendedReferenceTypes) );
		if(p_SupportFunctionPointerTypes != true)
			writer.WriteAttributeString( "SupportFunctionPointerTypes" ,CodeDOM_Utils.Att_ToString(p_SupportFunctionPointerTypes) );
		if(p_SupportExtendedTypes != true)
			writer.WriteAttributeString( "SupportExtendedTypes" ,CodeDOM_Utils.Att_ToString(p_SupportExtendedTypes) );
		if(p_AllowSetASCIIStringClass != false)
			writer.WriteAttributeString( "AllowSetASCIIStringClass" ,CodeDOM_Utils.Att_ToString(p_AllowSetASCIIStringClass) );
		if(p_AllowSetStringClass != false)
			writer.WriteAttributeString( "AllowSetStringClass" ,CodeDOM_Utils.Att_ToString(p_AllowSetStringClass) );
		if(p_AllowDisableNullReferenceCheckOnMemberAccess != false)
			writer.WriteAttributeString( "AllowDisableNullReferenceCheckOnMemberAccess" ,CodeDOM_Utils.Att_ToString(p_AllowDisableNullReferenceCheckOnMemberAccess) );
		if(p_SupportPointerArithmetics != false)
			writer.WriteAttributeString( "SupportPointerArithmetics" ,CodeDOM_Utils.Att_ToString(p_SupportPointerArithmetics) );
		if(p_AllowSetNullIntegerValue != false)
			writer.WriteAttributeString( "AllowSetNullIntegerValue" ,CodeDOM_Utils.Att_ToString(p_AllowSetNullIntegerValue) );
		if(p_NullIntegerValue != 0)
			writer.WriteAttributeString( "NullIntegerValue" ,CodeDOM_Utils.Att_ToString(p_NullIntegerValue) );
		if(p_AllowDisableBaseTypesArrayItemsInitialization != false)
			writer.WriteAttributeString( "AllowDisableBaseTypesArrayItemsInitialization" ,CodeDOM_Utils.Att_ToString(p_AllowDisableBaseTypesArrayItemsInitialization) );
		if(p_AllowDisableStaticsVarsInitialization != false)
			writer.WriteAttributeString( "AllowDisableStaticsVarsInitialization" ,CodeDOM_Utils.Att_ToString(p_AllowDisableStaticsVarsInitialization) );
		if(p_AllowDisableInstanceVarsInitialization != false)
			writer.WriteAttributeString( "AllowDisableInstanceVarsInitialization" ,CodeDOM_Utils.Att_ToString(p_AllowDisableInstanceVarsInitialization) );
		if(p_AllowIgnorePreviousAssingmentRules != true)
			writer.WriteAttributeString( "AllowIgnorePreviousAssingmentRules" ,CodeDOM_Utils.Att_ToString(p_AllowIgnorePreviousAssingmentRules) );
		if(p_AllowDisableAddressOfExpressionRequirementOnOutArguments != false)
			writer.WriteAttributeString( "AllowDisableAddressOfExpressionRequirementOnOutArguments" ,CodeDOM_Utils.Att_ToString(p_AllowDisableAddressOfExpressionRequirementOnOutArguments) );
		if(p_AllowFinalizeMethod != true)
			writer.WriteAttributeString( "AllowFinalizeMethod" ,CodeDOM_Utils.Att_ToString(p_AllowFinalizeMethod) );
		if(p_AllowNonNormalVirtualFunctionCallsOnConstructorsBody != false)
			writer.WriteAttributeString( "AllowNonNormalVirtualFunctionCallsOnConstructorsBody" ,CodeDOM_Utils.Att_ToString(p_AllowNonNormalVirtualFunctionCallsOnConstructorsBody) );
		if(p_AllowSelectiveVirtualMembers != true)
			writer.WriteAttributeString( "AllowSelectiveVirtualMembers" ,CodeDOM_Utils.Att_ToString(p_AllowSelectiveVirtualMembers) );
		if(p_AllowNonLimitedGotos != false)
			writer.WriteAttributeString( "AllowNonLimitedGotos" ,CodeDOM_Utils.Att_ToString(p_AllowNonLimitedGotos) );
		if(p_AllowSetRuntimeTypeInformation != true)
			writer.WriteAttributeString( "AllowSetRuntimeTypeInformation" ,CodeDOM_Utils.Att_ToString(p_AllowSetRuntimeTypeInformation) );
		if(p_AllowSetRuntimeReflection != false)
			writer.WriteAttributeString( "AllowSetRuntimeReflection" ,CodeDOM_Utils.Att_ToString(p_AllowSetRuntimeReflection) );
		if(p_AllowLimitRuntimeReflectionToModuleOnly != false)
			writer.WriteAttributeString( "AllowLimitRuntimeReflectionToModuleOnly" ,CodeDOM_Utils.Att_ToString(p_AllowLimitRuntimeReflectionToModuleOnly) );
		if(p_AllowResumeExceptionModel != false)
			writer.WriteAttributeString( "AllowResumeExceptionModel" ,CodeDOM_Utils.Att_ToString(p_AllowResumeExceptionModel) );
		if(p_AllowTerminationExceptionModel != true)
			writer.WriteAttributeString( "AllowTerminationExceptionModel" ,CodeDOM_Utils.Att_ToString(p_AllowTerminationExceptionModel) );
		if(p_AllowFinallyBlocks != true)
			writer.WriteAttributeString( "AllowFinallyBlocks" ,CodeDOM_Utils.Att_ToString(p_AllowFinallyBlocks) );
		if(p_AllowResumeNext != true)
			writer.WriteAttributeString( "AllowResumeNext" ,CodeDOM_Utils.Att_ToString(p_AllowResumeNext) );
		if(p_AllowMixedExceptionModel != false)
			writer.WriteAttributeString( "AllowMixedExceptionModel" ,CodeDOM_Utils.Att_ToString(p_AllowMixedExceptionModel) );
		if(p_AllowAnyTypeExceptions != false)
			writer.WriteAttributeString( "AllowAnyTypeExceptions" ,CodeDOM_Utils.Att_ToString(p_AllowAnyTypeExceptions) );
		if(p_AllowStackVarsAsExceptions != true)
			writer.WriteAttributeString( "AllowStackVarsAsExceptions" ,CodeDOM_Utils.Att_ToString(p_AllowStackVarsAsExceptions) );
		if(p_AllowRuntimeChecksFragmentedConfiguration != false)
			writer.WriteAttributeString( "AllowRuntimeChecksFragmentedConfiguration" ,CodeDOM_Utils.Att_ToString(p_AllowRuntimeChecksFragmentedConfiguration) );
		if(p_SupportedOperators != "")
			writer.WriteAttributeString( "SupportedOperators" ,CodeDOM_Utils.Att_ToString(p_SupportedOperators) );

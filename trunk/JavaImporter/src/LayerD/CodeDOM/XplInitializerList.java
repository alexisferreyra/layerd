...
public class XplInitializerList extends  XplNode implements XplNodeListCallbacks {
	...
	public int get_TypeName(){return CodeDOMTypes.XplInitializerList;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_array != false)
			writer.WriteAttributeString( "array" ,CodeDOM_Utils.Att_ToString(p_array) );
		if(p_doc != "")
	...
	public boolean InsertCallback(XplNodeList nodeList, XplNode node, XplNode parent){
		...
		if(node.get_Name().equals("e")){
			if(node.get_ContentTypeName()!=CodeDOMTypes.XplExpression){
				return false; //throw new CodeDOM_Exception("El elemento de tipo '"+node.get_ContentTypeNameString()+"' no es valido como componente de 'XplInitializerList'.");
			}
		...
		//throw new CodeDOM_Exception("El elemento de nombre '"+node.get_Name()+"' no es valido como componente de 'XplInitializerList'.");
		return false;
	}

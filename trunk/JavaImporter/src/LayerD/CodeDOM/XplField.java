...
public class XplField extends  XplNode{
	...
	public int get_TypeName(){return CodeDOMTypes.XplField;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_firstbit != 0)
			writer.WriteAttributeString( "firstbit" ,CodeDOM_Utils.Att_ToString(p_firstbit) );
		if(p_lastbit != 0)
			writer.WriteAttributeString( "lastbit" ,CodeDOM_Utils.Att_ToString(p_lastbit) );
		if(p_address != "")
			writer.WriteAttributeString( "address" ,CodeDOM_Utils.Att_ToString(p_address) );
		if(p_atomicwrite != false)
			writer.WriteAttributeString( "atomicwrite" ,CodeDOM_Utils.Att_ToString(p_atomicwrite) );
		if(p_atomicread != false)
			writer.WriteAttributeString( "atomicread" ,CodeDOM_Utils.Att_ToString(p_atomicread) );

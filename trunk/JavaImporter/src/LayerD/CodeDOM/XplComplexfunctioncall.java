...
public class XplComplexfunctioncall extends  XplNode{
	...
	public int get_TypeName(){return CodeDOMTypes.XplComplexfunctioncall;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_indexer != false)
			writer.WriteAttributeString( "indexer" ,CodeDOM_Utils.Att_ToString(p_indexer) );
		if(p_targetClass != "")
		...
		if(p_evaluate != false)
			writer.WriteAttributeString( "evaluate" ,CodeDOM_Utils.Att_ToString(p_evaluate) );

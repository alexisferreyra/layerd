...
public class XplBaseInitializer extends  XplNode{
	...
	public XplBaseInitializer(String n_className, String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata){
	...
	public XplBaseInitializer(String n_className, String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata, XplExpressionlist n_params){
		set_className(n_className);
		set_doc(n_doc);
		set_helpURL(n_helpURL);
		set_ldsrc(n_ldsrc);
	...
	public int get_TypeName(){return CodeDOMTypes.XplBaseInitializer;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_className != "")
			writer.WriteAttributeString( "className" ,CodeDOM_Utils.Att_ToString(p_className) );
		if(p_doc != "")
	...
	public XplNode Read(XplReader reader) throws ParseException, CodeDOM_Exception, IOException {
		...
		if( reader.HasAttributes() ){
			for(int i=1; i <= reader.AttributeCount() ; i++){
				...
				if(reader.Name().equals("className")){
					this.set_className(CodeDOM_Utils.StringAtt_To_STRING(reader.Value()));
				}
	...
	public static final XplExpressionlist new_params(){

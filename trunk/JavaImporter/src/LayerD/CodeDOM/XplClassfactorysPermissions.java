...
public class XplClassfactorysPermissions extends  XplNode implements XplNodeListCallbacks {

	//<editor-fold defaultstate="collapsed" desc=" Variables privadas para atributos y elementos ">
	boolean p_allowRead;
	boolean p_allowAppend;
	boolean p_allowChange;
	String p_doc;
	String p_helpURL;
	String p_ldsrc;
	boolean p_iny;
	...
	public XplClassfactorysPermissions(boolean n_allowRead, boolean n_allowAppend, boolean n_allowChange){
		p_allowRead = true;
		p_allowAppend = true;
		p_allowChange = true;
		p_doc = "";
	...
	public XplClassfactorysPermissions(boolean n_allowRead, boolean n_allowAppend, boolean n_allowChange, String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata){
		set_allowRead(n_allowRead);
		set_allowAppend(n_allowAppend);
		set_allowChange(n_allowChange);
		set_doc(n_doc);
	...
	public XplClassfactorysPermissions(XplNodeList n_Childs){
		p_allowRead = true;
		p_allowAppend = true;
		p_allowChange = true;
		p_doc = "";
	...
	public XplClassfactorysPermissions(boolean n_allowRead, boolean n_allowAppend, boolean n_allowChange, XplNodeList n_Childs){
		p_allowRead = true;
		p_allowAppend = true;
		p_allowChange = true;
		p_doc = "";
	...
	public XplClassfactorysPermissions(boolean n_allowRead, boolean n_allowAppend, boolean n_allowChange, String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata, XplNodeList n_Childs){
		set_allowRead(n_allowRead);
		set_allowAppend(n_allowAppend);
		set_allowChange(n_allowChange);
		set_doc(n_doc);
	...
	public int get_TypeName(){return CodeDOMTypes.XplClassfactorysPermissions;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_allowRead != true)
			writer.WriteAttributeString( "allowRead" ,CodeDOM_Utils.Att_ToString(p_allowRead) );
		if(p_allowAppend != true)
			writer.WriteAttributeString( "allowAppend" ,CodeDOM_Utils.Att_ToString(p_allowAppend) );
		if(p_allowChange != true)
			writer.WriteAttributeString( "allowChange" ,CodeDOM_Utils.Att_ToString(p_allowChange) );
		if(p_doc != "")
	...
	public XplNode Read(XplReader reader) throws ParseException, CodeDOM_Exception, IOException {
		...
		if( reader.HasAttributes() ){
			for(int i=1; i <= reader.AttributeCount() ; i++){
				...
				if(reader.Name().equals("allowRead")){
					this.set_allowRead(CodeDOM_Utils.StringAtt_To_BOOLEAN(reader.Value()));
				}
				else if(reader.Name().equals("allowAppend")){
					this.set_allowAppend(CodeDOM_Utils.StringAtt_To_BOOLEAN(reader.Value()));
				}
				else if(reader.Name().equals("allowChange")){
					this.set_allowChange(CodeDOM_Utils.StringAtt_To_BOOLEAN(reader.Value()));
				}
	...
	public boolean get_allowRead(){
		return p_allowRead;
	}
	public boolean get_allowAppend(){
		return p_allowAppend;
	}
	public boolean get_allowChange(){
	...
	public boolean set_allowRead(boolean new_allowRead){
		boolean back_allowRead = p_allowRead;
		p_allowRead = new_allowRead;
		return back_allowRead;
	}
	public boolean set_allowAppend(boolean new_allowAppend){
		boolean back_allowAppend = p_allowAppend;
		p_allowAppend = new_allowAppend;
		return back_allowAppend;
	}
	public boolean set_allowChange(boolean new_allowChange){
		boolean back_allowChange = p_allowChange;
	...
	public boolean InsertCallback(XplNodeList nodeList, XplNode node, XplNode parent){
		...
		if(node.get_Name().equals("cf")){
			if(node.get_ContentTypeName()!=CodeDOMTypes.String){
				return false; //throw new CodeDOM_Exception("El elemento de tipo '"+node.get_ContentTypeNameString()+"' no es valido como componente de 'XplClassfactorysPermissions'.");
			}
			node.set_Parent(parent);
			return true;
		}
		//throw new CodeDOM_Exception("El elemento de nombre '"+node.get_Name()+"' no es valido como componente de 'XplClassfactorysPermissions'.");
		return false;
	}
	...
	public static final XplNode new_cf(){

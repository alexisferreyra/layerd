...
public class XplSetonerror extends  XplNode{
	...
	public XplSetonerror(String n_label, String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata){
		set_label(n_label);
		set_doc(n_doc);
	...
	public int get_TypeName(){return CodeDOMTypes.XplSetonerror;}

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Namespace">
    <tr>
      <td>
        <b class="NamespaceKW">Namespace </b><xsl:value-of select="@name"/> :
        <b class="showmembers"
         ...
         onclick="mostrarNSMembers(this,this)">Show Namespace Members</b>
        <br/>
      ...
      <td >
        <xsl:choose>
          <xsl:when test="@isinterface">
            <b class="InterfaceKW">Interface </b>
          </xsl:when>
          <xsl:when test="@isstruct">
            <b class="StructKW">Struct </b>
          </xsl:when>
          <xsl:when test="@isenum">
            <b class="EnumKW">Enum </b>
          </xsl:when>
          <xsl:otherwise>
            <b class="ClassKW">Class </b>
          </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="@isinteractive">
          <b class="Modifier">interactive </b>
        </xsl:if>
        <xsl:if test="@abstract">
          <b class="Modifier">abstract </b>
        </xsl:if>
        <xsl:if test="@final">

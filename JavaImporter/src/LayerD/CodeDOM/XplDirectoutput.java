...
public class XplDirectoutput extends  XplNode{
	...
	public int get_TypeName(){return CodeDOMTypes.XplDirectoutput;}
	...
	public boolean Write(XplWriter writer) throws IOException, CodeDOM_Exception {
		...
		if(p_TargetPlatform != "")
			writer.WriteAttributeString( "TargetPlatform" ,CodeDOM_Utils.Att_ToString(p_TargetPlatform) );
		if(p_TargetPlatformDetail != "")
			writer.WriteAttributeString( "TargetPlatformDetail" ,CodeDOM_Utils.Att_ToString(p_TargetPlatformDetail) );
		if(p_output != "")
			writer.WriteAttributeString( "output" ,CodeDOM_Utils.Att_ToString(p_output) );
		if(p_doc != "")

...
public class XplCatchinit extends  XplNode{
	...
	public XplCatchinit(String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata){
		set_doc(n_doc);
	...
	public XplCatchinit(XplNode n_tcatchinit){
		p_doc = "";
		p_helpURL = "";
		p_ldsrc = "";
		p_iny = false;
	...
	public XplCatchinit(String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata, XplNode n_tcatchinit){
		set_doc(n_doc);
		set_helpURL(n_helpURL);
		set_ldsrc(n_ldsrc);
		set_iny(n_iny);
	...
	public int get_TypeName(){return CodeDOMTypes.XplCatchinit;}
	...
	public XplNode Read(XplReader reader) throws ParseException, CodeDOM_Exception, IOException {
		...
		while(reader.NodeType()!=XmlNodeType.ENDELEMENT){
			...
			if(this.get_tcatchinit()!=null && tempNode!=null)throw new CodeDOM_Exception("Linea: "+reader.LineNumber()+".Nodo '"+reader.Name()+"' incorrecto como hijo de elemento '"+this.get_Name()+"'.");
			else if(tempNode!=null)this.set_tcatchinit(tempNode);
			reader.Read();
		}
		}
		return this;
...
//Funciones para setear Elementos de Choice
	public XplNode set_tcatchinit(XplNode new_tcatchinit){
		if(new_tcatchinit==null)return p_tcatchinit;
		XplNode back_tcatchinit = p_tcatchinit;
		if(new_tcatchinit.get_Name().equals("d")){
		...
		if(new_tcatchinit.get_Name().equals("e")){
		...
		this.set_ErrorString("El elemento de nombre '"+new_tcatchinit.get_Name()+"' no es valido como componente de 'tcatchinit'.");
		return null;
	}
	//</editor-fold>

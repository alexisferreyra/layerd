...
public class XplDowhileStatement extends  XplNode{
	...
	public XplDowhileStatement(String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata){
		set_doc(n_doc);
	...
	public XplDowhileStatement(String n_doc, String n_helpURL, String n_ldsrc, boolean n_iny, String n_inydata, String n_inyby, String n_lddata, XplExpression n_boolean, XplFunctionBody n_dobk){
		set_doc(n_doc);
		set_helpURL(n_helpURL);
		set_ldsrc(n_ldsrc);
		set_iny(n_iny);
	...
	public int get_TypeName(){return CodeDOMTypes.XplDowhileStatement;}
		...
		while(reader.NodeType()!=XmlNodeType.ENDELEMENT){
			...
			switch(reader.NodeType()){
				case XmlNodeType.ELEMENT:
					...
					else if(reader.Name().equals("dobk")){
						tempNode = new XplFunctionBody();
						tempNode.Read(reader);
						if(this.get_dobk()!=null)throw new CodeDOM_Exception("Linea: "+reader.LineNumber()+".Nodo '"+reader.Name()+"' repetido como hijo de elemento '"+this.get_Name()+"'.");
	...
	public static final XplFunctionBody new_dobk(){
